...
annotation('textbox', [0.14, 0.75, 0.1, 0.1], 'String', "LMA 1 HMAT 35");
hold on

nexttile(2);
set(gca, 'Ylim', [0 40]);
xlabel('Offspring count');
annotation('textbox', [0.44, 0.75, 0.1, 0.1], 'String', "LMA .1 HMAT 25");
hold on 

nexttile(3)
set(gca, 'Ylim', [0 40]);
xlabel('Offspring count');
annotation('textbox', [0.74, 0.75, 0.1, 0.1], 'String', "LMA 2 HMAT 20");
hold on
